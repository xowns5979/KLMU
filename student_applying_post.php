						...
						<div class="inner">
							...
							<!-- Content -->
								<section>
									...
									<form method="post" id="do-contact" action="student_post_interest.php">
										<script>
										...
										<?php
											...
											$article_query="select * from student_applying_post where article_id = $article_id";
									...
									<form method="post" id="check-contact" action="student_post_interest_list.php">
										<?php 
											echo "<input type='hidden' name='article_id' value=$article_id>";
										?>
									</form>
