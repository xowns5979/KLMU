					...
					<div id="main">
						<div class="inner">
							...
							<!-- Content -->
								<section>
									<header class="main">
										<h1>Isyse Lab Info</h1>
									</header>
									<?php 
										$lab_query="select * from lab_information order by unique_id DESC";
										...
										if($result_lab){
											while($row = mysqli_fetch_array($result_lab)){
												...
												echo "<div class='box'>";
												echo "<h3>$name</h3>";
												echo "Professor : $professor &nbsp<a href='$link'>Link</a><br>";
												echo "Research Fields : $fields<br>";
												echo "Brief Descrption : <br>";
												echo "&nbsp&nbsp$description";
												echo "</div>";
											}
										}
										else {
