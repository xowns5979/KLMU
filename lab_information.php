						...
						<div class="inner">
							...
							<!-- Content -->
								<section>
									...
									<ul class="actions">
										<li><a href="lab_info/math.php" class="button big"><p style="font-family: Culim;">수학과</p></a></li>
										<li><a href="lab_info/physics.php" class="button big"><p style="font-family: Culim;">물리학과</p></a></li>
										<li><a href="lab_info/chemistry.php" class="button big"><p style="font-family: Culim;">화학과</p></a></li>
										<li><a href="lab_info/biology.php" class="button big"><p style="font-family: Culim;">생명과학과</p></a></li>
										
									</ul>
									<h2 style="font-family: Culim;">공과대</h2>
									<ul class="actions">
										<li><a href="lab_info/industrial.php" class="button big"><p style="font-family: Culim;">산업공학과</p></a></li>
										
										<li><a href="lab_info/computer.php" class="button big"><p style="font-family: Culim;">전산학과</p></a></li>
										<li><a href="lab_info/mechanic.php" class="button big"><p style="font-family: Culim;">기계공학과</p></a></li>
										<li><a href="lab_info/biochemical.php" class="button big"><p style="font-family: Culim;">생명화학공학과</p></a></li>	
									</ul>
								</section>
