<?php
	...
	function addToSPostDatabase($title_2, $body_2, $dept_2){
		global $connect;
		global $unique_id;
		global $username;

		$date = date("Y.m.d");
		$insert_query="insert into student_applying_post values (NULL, $unique_id, '$username', '$title_2', $dept_2, '$body_2', '$date');";
		...
		<!-- Wrapper -->
			<div id="wrapper">
				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							...
							<!-- Content -->
								<section>
									<header class="main">
										<h1>Student Posting</h1>
									</header>

									<form method="post" action="student_posting.php">
					...
					<?php
						if($title !="" and $body !=""){
							$isSaved = addToSPostDatabase($title, $body, $dept);
							if($isSaved){
