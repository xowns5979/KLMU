					...
					<div id="main">
						<div class="inner">
							...
							<!-- Content -->
								<section>
									<header class="main">
										<h1>Lab Recruiting Board</h1>
									</header>


									<form method="post" action="lab_recruiting_post.php">
										...
										<table>
											...
											<tbody>
												<?php 
													$article_query="select * from lab_recruiting_post order by article_id DESC";
									...
									<?php 
										if($type == "2"){
											echo "<a href='lab_posting.php' class='button'><p style='font-family: Culim;''>글쓰기</p></a>";
										}
									?>
