<?php
	...
	function addToReviewDatabase($lab_2, $rating_2, $body_2){
		global $connect;
		global $unique_id;
		global $username;

		$date = date("Y.m.d");
		$insert_query="insert into lab_review values (NULL, $lab_2, '$rating_2', '$body_2');";
		...
		<!-- Wrapper -->
			<div id="wrapper">
				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							...
							<!-- Content -->
								<section>
									<header class="main">
										<h1>Lab Review Posting</h1>
									</header>

									<form method="post" action="review_posting.php">
										
										<!-- Break -->
										<div class="4u 12u$(small)">
											<input type="radio" id="demo-priority-low" name="lab" value="1" checked>
											<label for="demo-priority-low">SDM LAB</label>
										</div>
										<div class="4u 12u$(small)">
											<input type="radio" id="demo-priority-normal" name="lab" value="2">
											<label for="demo-priority-normal">ISTAT LAB</label>
										</div>
										<div class="4u$ 12u$(small)">
											<input type="radio" id="demo-priority-high" name="lab" value="3">
											<label for="demo-priority-high">CSD LAB</label>
										</div>
										<div class="4u$ 12u$(small)">
											<input type="radio" id="demo-priority-high2" name="lab" value="4">
											<label for="demo-priority-high2">CE LAB</label>
										</div>
										<div class="4u$ 12u$(small)">
											<input type="radio" id="demo-priority-high3" name="lab" value="5">
											<label for="demo-priority-high3">AAI LAB</label>
										</div>
										
										<div class="6u 12u$(xsmall)">
											<div class="select-wrapper">
												<select name="rating" id="demo-category" required/>
					...
					<?php
						if($body !=""){
							$isSaved = addToReviewDatabase($lab, $rating, $body);
							if($isSaved){
								header("Location: lab_review/industrial.php");
								exit();
							}	
							else {
									echo "<script>";
