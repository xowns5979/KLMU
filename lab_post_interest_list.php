							...
							<!-- Content -->
								<section>
									...
									<?php
										...
										$article_query="select * from lab_post_interest where article_id = $article_id order by interest_id DESC";
										...
										if($result_article){
											while($row = mysqli_fetch_array($result_article)){
												...
												$get_query = "select * from student_account where unique_id = $author_unique_id";
